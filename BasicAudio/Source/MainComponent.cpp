...
public:
    ...
    { 
        ...
        frequencySlider[i].setRange (50, 1000, i*10);
        frequencySlider[i].setSkewFactorFromMidPoint (500);
        frequencySlider[i].setValue(263-i*50); // will also set the default frequency of the sine osc
...
private:
    // UI Elements
    Slider frequencySlider[Oscs],gainSlider[Oscs];
    
    ToggleButton enhanceButton[Oscs],onOffButton;
    
    Label frequencyLabel[Oscs],  gainLabel[Oscs], enhanceLabel[Oscs], onLable;
    
    Sine sine[Oscs]; // the sine wave oscillator
